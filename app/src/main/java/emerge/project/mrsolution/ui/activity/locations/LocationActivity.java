...
import emerge.project.mrsolution.ui.activity.visits.VisitsActivity;
import emerge.project.mrsolution.ui.adapters.locations.LocationTypeAdapter;
import emerge.project.mrsolution.ui.adapters.locations.LocationsDuplicateAdapter;
...
public class LocationActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener, LocationView ,GoogleApiClient.ConnectionCallbacks,
    ...
    public void onClickAddLocation(View view) {
        ...
        locationEntitie.setLocationTypeID(selectedLocationTypeID);
    ...
    public void locationTypeList(ArrayList<LocationType> locationTypeList) {
        locationTypeAdapter =  new LocationTypeAdapter(this,locationTypeList,this);
        recyclerViewType.setAdapter(locationTypeAdapter);
    }

    @Override
    public void locationTypeListEmpty() {
        Toast.makeText(this, "No Location Types", Toast.LENGTH_SHORT).show();
    }
    ...
    public void selectedLocationType(LocationType locationType) {
        selectedLocationTypeID = locationType.getId();
    }
